...
#line 790 "susan_edge_detector.h"
...
#line 804 "susan_edge_detector.h"
...
#line 846 "susan_edge_detector.h"
...
#line 894 "susan_edge_detector.h"
    c_handshake();
...
#line 916 "susan_edge_detector.h"
...
class read_image : public _specc::behavior
{
private:

#line 10 "read_image.sc"
    i_receive (&port_start); i_receiver (&port_in_stim); i_sender (&port_in1);
public:

#line 950 "susan_edge_detector.h"
    read_image(unsigned int _idcnt, i_receive (&port_start), i_receiver (&port_in_stim), i_sender (&port_in1));
    virtual ~read_image(void);
    void main(void);
private:

#line 12 "read_image.sc"
    char in_stim[7220];
};

#line 6 "setup_brightness_lut.sc"
class setup_brightness_lut : public _specc::behavior
{
private:
...
#line 969 "susan_edge_detector.h"
    setup_brightness_lut(unsigned int _idcnt, i_sender (&port_bp));
    virtual ~setup_brightness_lut(void);
    void main(void);
private:

#line 11 "setup_brightness_lut.sc"
    unsigned char bp[516];

#line 8 "setup_brightness_lut.sc"
    int k;
    float temp;
    int thresh;
};

#line 11 "susan_edges.sc"
class susan_edges : public _specc::behavior
{
private:

#line 11 "susan_edges.sc"
    i_receiver (&port_in1); i_sender (&port_in2); i_sender (&port_r); i_sender (&port_mid1); i_receiver (&port_bp);
public:

#line 993 "susan_edge_detector.h"
    susan_edges(unsigned int _idcnt, i_receiver (&port_in1), i_sender (&port_in2), i_sender (&port_r), i_sender (&port_mid1), i_receiver (&port_bp));
    virtual ~susan_edges(void);
    void main(void);
private:

#line 20 "susan_edges.sc"
    int a; int b;

#line 16 "susan_edges.sc"
    unsigned char bp[516];
...
#line 20 "susan_edges.sc"
    int do_symmetry; int i;

#line 14 "susan_edges.sc"
    unsigned char in1[7220];
...
#line 7 "detect_edges.sc"
class detect_edges : public _specc::behavior
{
private:

#line 7 "detect_edges.sc"
    i_receiver (&port_in1); i_sender (&port_in2); i_sender (&port_r); i_sender (&port_mid1);
public:

#line 1049 "susan_edge_detector.h"
    detect_edges(unsigned int _idcnt, i_receiver (&port_in1), i_sender (&port_in2), i_sender (&port_r), i_sender (&port_mid1));
    virtual ~detect_edges(void);
    void main(void);
private:
...
#line 9 "detect_edges.sc"
    c_queue com_bp;
    setup_brightness_lut setupBrightnessLut;
    susan_edges susanEdges;
};

#line 9 "edge_draw.sc"
class edge_draw : public _specc::behavior
{
private:

#line 9 "edge_draw.sc"
    i_receiver (&port_mid2); i_receiver (&port_in2); i_sender (&port_in3);
public:

#line 1071 "susan_edge_detector.h"
    edge_draw(unsigned int _idcnt, i_receiver (&port_mid2), i_receiver (&port_in2), i_sender (&port_in3));
    virtual ~edge_draw(void);
    void main(void);
private:
...
#line 11 "edge_draw.sc"
    int i;


    unsigned char in2[7220];
    unsigned char *inp;
    int j;
...
class susan_thin : public _specc::behavior
{
private:

#line 8 "susan_thin.sc"
    i_receiver (&port_r); i_receiver (&port_mid1); i_sender (&port_mid2);
public:

#line 1104 "susan_edge_detector.h"
    susan_thin(unsigned int _idcnt, i_receiver (&port_r), i_receiver (&port_mid1), i_sender (&port_mid2));
    virtual ~susan_thin(void);
    void main(void);
private:

#line 16 "susan_thin.sc"
    int a; int b;

#line 15 "susan_thin.sc"
    int b00;
...
#line 15 "susan.sc"
    i_receiver (&port_in1); i_sender (&port_in3);
public:

#line 1175 "susan_edge_detector.h"
    susan(unsigned int _idcnt, i_receiver (&port_in1), i_sender (&port_in3));
    virtual ~susan(void);
    void main(void);
private:
    unsigned long int _scc_const_port_0;
...
#line 22 "susan.sc"
    susan_thin susanThin;
};

#line 10 "write_image.sc"
class write_image : public _specc::behavior
{
private:

#line 10 "write_image.sc"
    i_receiver (&port_in3); i_sender (&port_out_monitor);
public:

#line 1214 "susan_edge_detector.h"
    write_image(unsigned int _idcnt, i_receiver (&port_in3), i_sender (&port_out_monitor));
    virtual ~write_image(void);
    void main(void);
private:

#line 12 "write_image.sc"
    char in3_buffer[7220];
};
...
#line 13 "design.sc"
    i_receive (&port_start); i_receiver (&port_in_stim); i_sender (&port_out_monitor);
public:

#line 1233 "susan_edge_detector.h"
    design(unsigned int _idcnt, i_receive (&port_start), i_receiver (&port_in_stim), i_sender (&port_out_monitor));
    virtual ~design(void);
    void main(void);
private:
    unsigned long int _scc_const_port_0;
...
#line 15 "design.sc"
    c_queue com_read_susan; c_queue com_susan_write;
...
#line 1257 "susan_edge_detector.h"
    monitor(unsigned int _idcnt, i_receiver (&port_in3));
...
#line 10 "stimulus.sc"
    i_send (&port_start); i_sender (&port_in1);
public:

#line 1281 "susan_edge_detector.h"
    stimulus(unsigned int _idcnt, i_send (&port_start), i_sender (&port_in1));
...
#line 1300 "susan_edge_detector.h"
    Main(unsigned int _idcnt);
    virtual ~Main(void);
    int main(void);
private:

#line 18 "susan_edge_detector.sc"
    design des;

#line 14 "susan_edge_detector.sc"
    c_double_handshake image_in; c_double_handshake image_out;
...
extern "C" int creat(const char *, unsigned int);

#line 159 "/usr/include/fcntl.h"
extern "C" int lockf(int, int, long int);

#line 176 "/usr/include/fcntl.h"
extern "C" int posix_fadvise(int, long int, long int, int);

#line 198 "/usr/include/fcntl.h"
extern "C" int posix_fallocate(int, long int, long int);
...
#line 60 "c_double_handshake.sc"
extern "C" void *memcpy(void *, const void *, unsigned int);

#line 2236 "susan_edge_detector.h"
