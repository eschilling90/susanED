...
behavior susan_thin(i_intarray_receiver port_r, i_image_receiver port_mid1, i_image_sender port_mid2)
{
int r[X_SIZE*Y_SIZE];
...
behavior susan_thin_fsm(i_intarray_receiver port_r, i_image_receiver port_mid1, i_image_sender port_mid2)
{
