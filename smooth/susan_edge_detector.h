...
#line 4 "c_int7220_queue.sc"
typedef int int7220[7220];

#line 4 "c_uchar7220_queue.sc"
...
#line 716 "susan_edge_detector.h"
class c_double_handshake_signal;
class Smooth;
class SusanSmoothing;
class SusanSmooth_ReadInput;
class SusanSmooth_WriteOutput;
class Smoothing;
class SusanSmooth;
...
#line 729 "susan_edge_detector.h"
...
#line 796 "susan_edge_detector.h"
class i_send;

#line 27 "i_send.sc"
/* note i_send._SCE_STANDARD_LIB = { "i_send" }; */

#line 802 "susan_edge_detector.h"
class i_sender;

#line 26 "i_sender.sc"
/* note i_sender._SCE_STANDARD_LIB = { "i_sender" }; */

#line 808 "susan_edge_detector.h"
class i_tranceiver;
...
#line 831 "susan_edge_detector.h"
...
#line 845 "susan_edge_detector.h"
...
#line 873 "susan_edge_detector.h"
...
#line 887 "susan_edge_detector.h"
...
#line 901 "susan_edge_detector.h"
...
#line 929 "susan_edge_detector.h"
...
#line 943 "susan_edge_detector.h"
    virtual ~i_send(void){};
...
#line 971 "susan_edge_detector.h"
...
#line 990 "susan_edge_detector.h"
...
#line 5 "./susan_smooth1.sc"
class SusanSmoothing : public _specc::behavior
{
private:

#line 5 "./susan_smooth1.sc"
    unsigned char (&in0)[7220]; unsigned char (&bp)[516]; unsigned char (&out0)[7220];
public:

#line 1016 "susan_edge_detector.h"
    SusanSmoothing(unsigned int _idcnt, unsigned char (&in0)[7220], unsigned char (&bp)[516], unsigned char (&out0)[7220]);
    virtual ~SusanSmoothing(void);
    void enlarge(unsigned char [7220], unsigned char [9810]);
    void main(void);
    unsigned char median(unsigned char [9810], int, int, int);
private:

#line 9 "./susan_smooth1.sc"
    int area; int brightness; int centre;
    unsigned char cp; unsigned char dp[225]; unsigned char dpt[225];
    float dt;

#line 9 "./susan_smooth1.sc"
    int i;
    unsigned char in1[9810];

#line 9 "./susan_smooth1.sc"
    int increment; int j; int k; int l; int mask_size;
    unsigned char med;

#line 9 "./susan_smooth1.sc"
    int n_max;

#line 8 "./susan_smooth1.sc"
    float temp;
    int tmp;
...
#line 9 "./susan_smooth1.sc"
    int x; int x_size; int y; int y_size;
};

#line 144 "./susan_smooth1.sc"
class SusanSmooth_ReadInput : public _specc::behavior
{
private:

#line 144 "./susan_smooth1.sc"
    i_uchar7220_receiver (&in_in0); unsigned char (&in0)[7220];
public:

#line 1059 "susan_edge_detector.h"
    SusanSmooth_ReadInput(unsigned int _idcnt, i_uchar7220_receiver (&in_in0), unsigned char (&in0)[7220]);
    virtual ~SusanSmooth_ReadInput(void);
    void main(void);
private:
};

#line 152 "./susan_smooth1.sc"
class SusanSmooth_WriteOutput : public _specc::behavior
{
private:

#line 152 "./susan_smooth1.sc"
    i_uchar7220_sender (&out_in0); unsigned char (&in0)[7220];
public:

#line 1075 "susan_edge_detector.h"
    SusanSmooth_WriteOutput(unsigned int _idcnt, i_uchar7220_sender (&out_in0), unsigned char (&in0)[7220]);
    virtual ~SusanSmooth_WriteOutput(void);
    void main(void);
private:
};

#line 159 "./susan_smooth1.sc"
class Smoothing : public _specc::behavior
{
private:

#line 159 "./susan_smooth1.sc"
    i_uchar7220_receiver (&in_image); unsigned char (&bp)[516]; i_uchar7220_sender (&out_image);
public:

#line 1091 "susan_edge_detector.h"
    Smoothing(unsigned int _idcnt, i_uchar7220_receiver (&in_image), unsigned char (&bp)[516], i_uchar7220_sender (&out_image));
    virtual ~Smoothing(void);
    void main(void);
private:

#line 161 "./susan_smooth1.sc"
    unsigned char image_buffer[7220];
    unsigned char out_image_buffer[7220];

    SusanSmooth_ReadInput susan_smooth_read_input;
    SusanSmooth_WriteOutput susan_smooth_write_output;
    SusanSmoothing susan_smoothing;
};
...
#line 1115 "susan_edge_detector.h"
...
#line 1131 "susan_edge_detector.h"
...
#line 178 "./susan_smooth1.sc"
class SusanSmooth : public _specc::behavior
{
private:

#line 178 "./susan_smooth1.sc"
    i_uchar7220_receiver (&in0); i_uchar7220_sender (&in0_out);
public:

#line 1153 "susan_edge_detector.h"
    SusanSmooth(unsigned int _idcnt, i_uchar7220_receiver (&in0), i_uchar7220_sender (&in0_out));
    virtual ~SusanSmooth(void);
    void main(void);
private:

#line 181 "./susan_smooth1.sc"
    unsigned char bp[516];
...
#line 9 "./smooth.sc"
class Smooth : public _specc::behavior
{
private:
...
#line 1197 "susan_edge_detector.h"
    Smooth(unsigned int _idcnt, i_uchar7220_receiver (&in_image), i_uchar7220_sender (&out_image));
    virtual ~Smooth(void);
    void main(void);
private:
...
#line 12 "./smooth.sc"
    c_uchar7220_queue image_smooth;
...
#line 1216 "susan_edge_detector.h"
    c_double_handshake();
...
#line 1248 "susan_edge_detector.h"
...
#line 1304 "susan_edge_detector.h"
...
#line 1320 "susan_edge_detector.h"
...
#line 1336 "susan_edge_detector.h"
...
#line 1362 "susan_edge_detector.h"
...
#line 1378 "susan_edge_detector.h"
...
#line 1393 "susan_edge_detector.h"
...
#line 2319 "susan_edge_detector.h"
