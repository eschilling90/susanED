...
behavior EdgeDrawThread_PartA(uchar image_buffer[IMAGE_SIZE], uchar mid[IMAGE_SIZE], in int thID)
{
...
behavior EdgeDrawThread_PartB(uchar image_buffer[IMAGE_SIZE], uchar mid[IMAGE_SIZE], in int thID)
{
...
behavior EdgeDraw_PartA(uchar image_buffer[IMAGE_SIZE], uchar mid[IMAGE_SIZE])
{
...
behavior EdgeDraw_PartB(uchar image_buffer[IMAGE_SIZE], uchar mid[IMAGE_SIZE])
{
