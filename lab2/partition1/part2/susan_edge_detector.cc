...
Design::Design(unsigned int _idcnt, i_receive (&start), unsigned char (&image_buffer)[7220], i_sender (&out_image_susan))
    ...
    susan(++_IDcnt, in_image, out_image),
...
void Design::main(void) {
    { _specc::fork _scc_fork_0(&read_image), _scc_fork_1(&susan), _scc_fork_2(&write_image); _specc::par(
	    &_scc_fork_0, 
	    &_scc_fork_1, 
...
#line 380 "susan_edge_detector.cc"
...
#line 398 "susan_edge_detector.cc"
...
#line 435 "susan_edge_detector.cc"
...
#line 466 "susan_edge_detector.cc"
...
#line 83 "edge_draw.sc"
void EdgeDraw_PartA::main(void) {
    { enum { _scc_state_0, _scc_state_edge_draw_a_thread_0, _scc_state_edge_draw_a_thread_1 } _scc_next_state = _scc_state_edge_draw_a_thread_0; do switch(_scc_next_state) {
	    case _scc_state_edge_draw_a_thread_0: { edge_draw_a_thread_0.main(); { _scc_next_state = _scc_state_edge_draw_a_thread_1; break; } }
	    case _scc_state_edge_draw_a_thread_1: { edge_draw_a_thread_1.main(); { _scc_next_state = _scc_state_edge_draw_a_thread_0; break; } } case _scc_state_0: { _scc_next_state = _scc_state_0; break; } } while(_scc_next_state != _scc_state_0);
    }
}

#line 519 "susan_edge_detector.cc"
...
void EdgeDraw_PartB::main(void) {
    { enum { _scc_state_0, _scc_state_edge_draw_b_thread_0, _scc_state_edge_draw_b_thread_1 } _scc_next_state = _scc_state_edge_draw_b_thread_0; do switch(_scc_next_state) {
	    case _scc_state_edge_draw_b_thread_0: { edge_draw_b_thread_0.main(); { _scc_next_state = _scc_state_edge_draw_b_thread_1; break; } }
	    case _scc_state_edge_draw_b_thread_1: { edge_draw_b_thread_1.main(); { _scc_next_state = _scc_state_edge_draw_b_thread_0; break; } } case _scc_state_0: { _scc_next_state = _scc_state_0; break; } } while(_scc_next_state != _scc_state_0);
    }
}
...
#line 566 "susan_edge_detector.cc"
...
#line 584 "susan_edge_detector.cc"
...
#line 639 "susan_edge_detector.cc"
...
#line 662 "susan_edge_detector.cc"
...
#line 696 "susan_edge_detector.cc"
...
#line 37 "setup_brightness_lut.sc"
void SetupBrightnessLut::main(void) {
    { enum { _scc_state_0, _scc_state_setup_brightness_thread_0, _scc_state_setup_brightness_thread_1 } _scc_next_state = _scc_state_setup_brightness_thread_0; do switch(_scc_next_state) {
	    case _scc_state_setup_brightness_thread_0: { setup_brightness_thread_0.main(); { _scc_next_state = _scc_state_setup_brightness_thread_1; break; } }
	    case _scc_state_setup_brightness_thread_1: { setup_brightness_thread_1.main(); { _scc_next_state = _scc_state_0; break; } } case _scc_state_0: { _scc_next_state = _scc_state_0; break; } } while(_scc_next_state != _scc_state_0);
    }
}
...
{   
    { enum { _scc_state_0, _scc_state_edges, _scc_state_thin, _scc_state_draw } _scc_next_state = _scc_state_edges; do switch(_scc_next_state) {
	    case _scc_state_edges: { edges.main(); { _scc_next_state = _scc_state_thin; break; } }
	    case _scc_state_thin: { thin.main(); { _scc_next_state = _scc_state_draw; break; } }
	    case _scc_state_draw: { draw.main(); { _scc_next_state = _scc_state_edges; break; } } case _scc_state_0: { _scc_next_state = _scc_state_0; break; } } while(_scc_next_state != _scc_state_0);
    }
}

#line 857 "susan_edge_detector.cc"
...
#line 982 "susan_edge_detector.cc"
...
#line 255 "susan_edges.sc"
			    {    a = 1; b = 1;
			    }
			}
		    }

#line 256 "susan_edges.sc"
		    if ((m > r[(i + a) * 76 + j + b]) && (m >= r[(i - a) * 76 + j - b]) && 
			(m > r[(i + (2 * a)) * 76 + j + (2 * b)]) && (m >= r[(i - (2 * a)) * 76 + j - (2 * b)]))
			mid[i * 76 + j] = 2;
		}
...
#line 1204 "susan_edge_detector.cc"
...
#line 1222 "susan_edge_detector.cc"
...
#line 1239 "susan_edge_detector.cc"
...
void SusanEdges_PartA::main(void) {
    { enum { _scc_state_0, _scc_state_susan_edges_a_thread_0, _scc_state_susan_edges_a_thread_1 } _scc_next_state = _scc_state_susan_edges_a_thread_0; do switch(_scc_next_state) {
	    case _scc_state_susan_edges_a_thread_0: { susan_edges_a_thread_0.main(); { _scc_next_state = _scc_state_susan_edges_a_thread_1; break; } }
	    case _scc_state_susan_edges_a_thread_1: { susan_edges_a_thread_1.main(); { _scc_next_state = _scc_state_susan_edges_a_thread_0; break; } } case _scc_state_0: { _scc_next_state = _scc_state_0; break; } } while(_scc_next_state != _scc_state_0);
    }
}
...
#line 308 "susan_edges.sc"
void SusanEdges_PartB::main(void) {
    { enum { _scc_state_0, _scc_state_susan_edges_b_thread_0, _scc_state_susan_edges_b_thread_1 } _scc_next_state = _scc_state_susan_edges_b_thread_0; do switch(_scc_next_state) {
	    case _scc_state_susan_edges_b_thread_0: { susan_edges_b_thread_0.main(); { _scc_next_state = _scc_state_susan_edges_b_thread_1; break; } }
	    case _scc_state_susan_edges_b_thread_1: { susan_edges_b_thread_1.main(); { _scc_next_state = _scc_state_susan_edges_b_thread_0; break; } } case _scc_state_0: { _scc_next_state = _scc_state_0; break; } } while(_scc_next_state != _scc_state_0);
    }
}

#line 1283 "susan_edge_detector.cc"
...
#line 1308 "susan_edge_detector.cc"
...
#line 1534 "susan_edge_detector.cc"
...
#line 1550 "susan_edge_detector.cc"
...
#line 1565 "susan_edge_detector.cc"
...
void SusanThin::main(void) {
    { enum { _scc_state_0, _scc_state_susan_thin_thread_0, _scc_state_susan_thin_thread_1 } _scc_next_state = _scc_state_susan_thin_thread_0; do switch(_scc_next_state) {
	    case _scc_state_susan_thin_thread_0: { susan_thin_thread_0.main(); { _scc_next_state = _scc_state_susan_thin_thread_1; break; } }
	    case _scc_state_susan_thin_thread_1: { susan_thin_thread_1.main(); { _scc_next_state = _scc_state_susan_thin_thread_0; break; } } case _scc_state_0: { _scc_next_state = _scc_state_0; break; } } while(_scc_next_state != _scc_state_0);
    }
}
...
#line 1609 "susan_edge_detector.cc"
...
#line 1630 "susan_edge_detector.cc"
