...
#ifndef C_TYPED_LEFT_QUEUE_SH
#define C_TYPED_LEFT_QUEUE_SH
...
#include "os_typed_left_tranceiver.sh"
...
{									\
	...
	{								\
	    ...
	    buffer = 0;							\
									...
									\
    void receive(type *d, int threadID)					\
    {									\
	while(! n)							\
	{								\
	    wr++;							\
