...
{ "-lscprof" }; */
/* note _SCE_LOG = 
{ { "Sat Jun 23 15:42:21 2012","scc Design -sc2sir -I -P -L -l -xcx -xlx -I/ECEnet/Apps1/sce-20100908/inc -P. -P/ECEnet/Apps1/sce-20100908/import -L/ECEnet/Apps1/sce-20100908/lib -lbit -lbit4 -lsim -llonglong -lqthread -xl -Xlinker -xl -R -xl -Xlinker -xl /ECEnet/Apps1/sce-20100908/lib -i Design.sc -o Design.sir",
    "Design.sc","V2.2.1","" },
  { "Sat Jun 23 15:43:14 2012","sce","Design.sc","V2.2.1","Saved to /home/student/tabkhi/project/bge/frame-based/Designspec.sir" },
  
  { "Sat Jun 23 15:43:14 2012","scprof -v -m -i /home/student/tabkhi/project/bge/frame-based/Designspec.sir -o /home/student/tabkhi/project/bge/frame-based/Designspec.ins.sir Designspec ",
    "Designspec","V2.2.1","Profile Instrumentation Simple mode" } }; */
...
#line 12 "./bgelim.sc"
    i_receive (&start); i_receiver (&frameRGB);
    i_sender (&frameBg); i_sender (&frameFg);
public:

#line 1057 "Designspec.h"
...
#line 12 "Design.sc"
class Testbench : public _specc::behavior
{
private:
public:

#line 1138 "Designspec.h"
    Testbench(unsigned int _idcnt);
